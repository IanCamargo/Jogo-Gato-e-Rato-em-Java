...
public class JogoGatoERato {
    ...
    // Estratégia manual: o usuario escolhe a porta até encontrar o rato.
    public int jogarManual() {
        Scanner scanner = new Scanner(System.in);
        boolean ratoEncontrado = false;
        int tentativas = 0;
        Set<Integer> portasEscolhidas = new HashSet<>(); // Rastreia as portas escolhidas
        ...
        while (!ratoEncontrado) {
            ...
            if (portasEscolhidas.contains(portaEscolhida)) {
                System.out.println("Você já escolheu essa porta. Tente novamente!");
                continue;
            }

            portasEscolhidas.add(portaEscolhida); // Adiciona a porta escolhida ao conjunto
            tentativas++;
